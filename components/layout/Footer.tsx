...
export default function Footer() {
  return (
    <footer style={{ background: '#0f172a', color: '#94a3b8', marginTop: 48 }}>
      <div className="footer-grid" style={{ maxWidth: 1200, margin: '0 auto', padding: '42px 20px 28px', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px,1fr))', gap: 32 }}>
        {/* Brand */}
        <div>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 16 }}>
            <span aria-label="Telegram" style={{ width: 36, height: 36, borderRadius: 10, background: '#229ED9', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', flexShrink: 0 }}>
            ...
            <span aria-label="ВКонтакте" style={{ width: 36, height: 36, borderRadius: 10, background: '#0077FF', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', flexShrink: 0 }}>
            ...
            <span aria-label="Instagram" style={{ width: 36, height: 36, borderRadius: 10, background: 'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', flexShrink: 0 }}>
        ...
        <div>
          ...
          {[
            { label: 'Сдаю жильё', href: '/?cat=housing' },
            { label: 'Сниму жильё', href: '/?cat=findhousing' },
            { label: 'Работа', href: '/?cat=jobs' },
            { label: 'Продаю/Куплю', href: '/?cat=sell' },
            { label: 'Услуги', href: '/?cat=services' },
          ].map(c => (
            <Link key={c.href} href={c.href} style={{ display: 'block', marginBottom: 8, fontSize: 13, color: '#94a3b8', transition: 'color 0.15s' }}>
              {c.label}
            </Link>
          ))}
        </div>
        ...
        <div>
          <h4 style={{ color: '#e2e8f0', fontWeight: 700, marginBottom: 12, fontSize: 14 }}>Документы</h4>
          <Link href="/privacy" style={{ display: 'block', marginBottom: 8, fontSize: 13, color: '#94a3b8' }}>Политика конфиденциальности</Link>
          <Link href="/terms" style={{ display: 'block', marginBottom: 8, fontSize: 13, color: '#94a3b8' }}>Пользовательское соглашение</Link>
        </div>
      </div>
